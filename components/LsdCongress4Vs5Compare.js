...
import { GitCompare, Calendar, Compass, Sprout, Layers, UserCheck, CheckCircle2 } from "lucide-react";

export default function LsdCongress4Vs5Compare() {
  ...
  const comparisons = [
    {
      ...
      dh4: "Chưa nêu rõ 'hai nhiệm vụ chiến lược' song song trong văn kiện",
      dh5: "CHÍNH THỨC NÊU 'HAI NHIỆM VỤ CHIẾN LƯỢC': Xây dựng CNXH & Bảo vệ Tổ quốc ⭐️",
      highlight: "Lần đầu tiên hai nhiệm vụ chiến lược được khẳng định chính thức và trở thành kim chỉ nam xuyên suốt."
    },
    {
      id: "industry",
      icon: Sprout,
      title: "Đường lối công nghiệp hóa",
      dh4: "Ưu tiên phát triển công nghiệp nặng một cách toàn diện, nhanh",
      dh5: "Coi NÔNG NGHIỆP LÀ MẶT TRẬN HÀNG ĐẦU, kết hợp nông - công nghiệp hợp lý ⭐️",
      highlight: "Bước điều chỉnh tư duy kinh tế đột phá: Tập trung sản xuất lương thực - thực phẩm và hàng tiêu dùng trước."
    },
    {
      id: "economy",
      icon: Layers,
      title: "Nhận thức kinh tế",
      dh4: "Chủ trương cải tạo XHCN nhanh, đồng loạt trên cả nước",
      dh5: "THỪA NHẬN TỒN TẠI NHIỀU THÀNH PHẦN KINH TẾ ở miền Nam trong một thời gian",
      highlight: "Mầm mống tư duy đổi mới kinh tế (kết hợp động lực Khoán 100 và HNTW 8 xóa bao cấp)."
    },
    {
      id: "context",
      icon: Calendar,
      title: "Bối cảnh đất nước",
      dh4: "Mới thống nhất đất nước, khí thế lạc quan sau Đại thắng 1975",
      dh5: "Đối diện trực tiếp với KHỦNG HOẢNG KINH TẾ - XÃ HỘI & chiến tranh biên giới",
      highlight: "Đảng nhìn thẳng vào khuyết điểm chủ quan trong lãnh đạo, quản lý để bắt đầu quá trình trăn trở đổi mới."
    },
    {
      id: "leader",
      icon: UserCheck,
      title: "Tổng Bí thư đứng đầu",
      dh4: "Lê Duẩn (Bầu lần đầu với tên gọi Đảng Cộng sản Việt Nam)",
      dh5: "Lê Duẩn (Bầu lại; giữ chức đến khi từ trần 7/1986 ➔ Trường Chinh kế nhiệm)",
      highlight: "Đại hội V là Đại hội cuối cùng của Tổng Bí thư Lê Duẩn trước đợt chuyển giao nhân sự lịch sử năm 1986."
    }
  ];
    ...
    <div className="my-10 p-6 md:p-8 rounded-3xl bg-gradient-to-br from-stone-900 via-stone-850 to-stone-950 text-white shadow-2xl border border-pink-500/30 relative overflow-hidden select-none">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 relative z-10 border-b border-white/10 pb-6">
        <div>
          ...
          <h3 className="text-2xl md:text-3xl font-extrabold font-playfair tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-pink-200 to-white">
            Bảng So sánh Điểm mới: Đại hội IV (1976) vs Đại hội V (1982)
          </h3>
          <p className="text-stone-400 text-xs md:text-sm mt-1">
            Bấm vào từng tiêu chí bên dưới để xem phân tích chi tiết bước chuyển tư duy kinh tế
          </p>
        </div>
      </div>
      ...
      <div className="space-y-3 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-3 px-4 py-3 bg-stone-900/90 rounded-2xl border border-white/10 font-bold text-xs text-stone-300 tracking-wider uppercase">
          ...
          <div className="col-span-4 font-extrabold text-red-400 flex items-center gap-1.5">
      ...
      <div className="mt-6 p-4 rounded-2xl bg-pink-500/10 border border-pink-500/20 flex items-center justify-between gap-4 text-xs text-pink-200 relative z-10">
        <div className="flex items-center gap-2">
          ...
          <span><strong>Mẹo nhớ nhanh:</strong> ĐH V bắt đầu điều chỉnh tư duy so với ĐH IV: từ ưu tiên công nghiệp nặng ➔ <strong>NÔNG NGHIỆP LÀ MẶT TRẬN HÀNG ĐẦU</strong>. Đây là bước quá độ tư duy, tiền đề trực tiếp cho Đổi mới ở ĐH VI.</span>
        </div>
      </div>
    </div>
  );
