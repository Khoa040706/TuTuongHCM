...
export default function LsdSection1MegaReview() {
  ...
  const flashcards = [
    {
      q: "Ba bước đột phá đổi mới kinh tế trước Đại hội VI diễn ra vào những thời điểm nào?",
      a: "Đột phá 1 (Tháng 8-1979 - TW 6); Đột phá 2 (Tháng 6-1985 - TW 8); Đột phá 3 (Tháng 8-1986 - Kết luận Bộ Chính trị)."
    },
    {
      q: "Sự kiện lịch sử ngày 14-7-1986 là gì?",
      a: "Hội nghị Trung ương bất thường bầu đồng chí Trường Chinh làm Tổng Bí thư của Đảng."
    },
    {
      q: "Trận chiến đấu bảo vệ biên giới phía Bắc chống 60 vạn quân xâm lược bắt đầu vào ngày nào?",
      a: "Ngày 17-2-1979 (đến ngày 5-3-1979 Chủ tịch Tôn Đức Thắng ra Lệnh Tổng động viên toàn quốc)."
    },
    {
      q: "Tên nước Cộng hòa Xã hội Chủ nghĩa Việt Nam chính thức được thông qua tại sự kiện nào?",
      a: "Kỳ họp thứ nhất Quốc hội khóa VI (từ ngày 24-6 đến 3-7-1976)."
    }
  ];

  const keywords = [
    { title: "25-4-1976", desc: "Tổng tuyển cử bầu Quốc hội chung khóa VI cả nước", cat: "Mốc lịch sử" },
    { title: "Đại hội IV (12-1976)", desc: "Đổi tên Đảng thành Đảng Cộng sản Việt Nam, Lê Duẩn làm Tổng Bí thư", cat: "Đại hội" },
    { title: "7-1-1979", desc: "Giải phóng Phnôm Pênh, cứu nhân dân Campuchia khỏi họa diệt chủng Pol Pot", cat: "Chiến công" },
    { title: "17-2-1979", desc: "Cuộc chiến đấu bảo vệ biên giới Phía Bắc", cat: "Chiến đấu" },
    { title: "Hội nghị TW 6 (8-1979)", desc: "Bước đột phá thứ nhất đổi mới kinh tế ('làm cho sản xuất bung ra')", cat: "Đột phá 1" },
    { title: "Chỉ thị 100-CT/TW (1-1981)", desc: "Khoán sản phẩm đến nhóm và người lao động ('Khoán 100') trong nông nghiệp", cat: "Chỉ thị" },
    { title: "Đại hội V (3-1982)", desc: "Xác định 'chặng đường đầu tiên', coi 'Nông nghiệp là mặt trận hàng đầu'", cat: "Đại hội" },
    { title: "Hội nghị TW 8 (6-1985)", desc: "Bước đột phá thứ hai về Giá - Lương - Tiền, dứt khoát xóa bỏ bao cấp", cat: "Đột phá 2" },
    { title: "Kết luận BCT (8-1986)", desc: "Bước đột phá thứ ba về 3 quan điểm kinh tế lớn", cat: "Đột phá 3" },
    { title: "14-7-1986", desc: "Hội nghị TW bầu đồng chí Trường Chinh làm Tổng Bí thư", cat: "Chuyển giao" }
  ];
    ...
    <div className="my-8 rounded-2xl border border-amber-300 dark:border-amber-700 bg-gradient-to-br from-amber-50/50 via-white to-red-50/40 p-6 md:p-8 shadow-xl">
      ...
      <div className="text-center max-w-3xl mx-auto mb-8">
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-600 text-white text-xs font-bold uppercase tracking-wider mb-2">
          <Star size={14} className="fill-amber-300 text-amber-300" /> Mega Hub Trọn Bộ Mục I (1975-1986)
        </span>
        <h3 className="text-2xl md:text-3xl font-black font-serif text-slate-900 dark:text-white">
          Mega Hub Ôn Tập Trắc Nghiệm Trọn Bộ 10 Năm (1975 - 1986)
        </h3>
      </div>
      ...
      {activeTab === "keywords" && (
        <div>
          <div className="max-w-xs mx-auto mb-6 relative">
            ...
            <input
              type="text"
              placeholder="Tra từ khóa 1975-1986..."
              value={searchTerm}
