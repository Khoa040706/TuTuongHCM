...
export default function DatabaseCh2Part1ConceptQuiz() {
  ...
  const questions = [
    {
      id: 1,
      question: "1. Trong mô hình quan hệ, một quan hệ r trên lược đồ R(A₁, ..., Aₙ) được định nghĩa là gì?",
      options: [
        "Một tập hợp các chương trình quản lý",
        "Một tập con của tích Descartes các miền",
        "Một thiết bị phần cứng lưu trữ vật lý",
        "Một bảng chứa các thuộc tính có cùng tên"
      ],
      correctAnswer: 1,
      explanation: "Theo định nghĩa toán học, một quan hệ r trên LĐQH R là một tập con của tích Descartes các miền giá trị: r ⊆ D(A₁) × D(A₂) × ... × D(Aₙ)."
    },
    {
      id: 2,
      question: "2. Khẳng định nào sau đây là ĐÚNG theo lý thuyết tập hợp của mô hình dữ liệu quan hệ?",
      options: [
        "Thứ tự các dòng và các cột là quan trọng",
        "Thứ tự các dòng và các cột không quan trọng",
        "Có thể tồn tại hai dòng hoàn toàn giống nhau",
        "Quan hệ bắt buộc phải chứa ít nhất mười dòng"
      ],
      correctAnswer: 1,
      explanation: "Vì quan hệ là một tập hợp, thứ tự của các dòng và các cột không quan trọng. Đồng thời không tồn tại 2 phần tử giống hệt nhau trong một tập hợp."
    },
    {
      id: 3,
      question: "3. Siêu khóa (Super Key) của một lược đồ quan hệ R có đặc trưng cơ bản nào sau đây?",
      options: [
        "Không thể chứa bất kỳ thuộc tính dư thừa nào",
        "Luôn xác định duy nhất một bộ trong quan hệ",
        "Bắt buộc phải là khóa ngoại của quan hệ khác",
        "Chỉ gồm đúng một thuộc tính duy nhất trong R"
      ],
      correctAnswer: 1,
      explanation: "Siêu khóa là một tập hợp gồm một hay nhiều thuộc tính của R có tính chất xác định duy nhất một bộ trong mỗi thể hiện của R (t_i(SK) ≠ t_j(SK))."
    },
    {
      id: 4,
      question: "4. Khóa chính (Primary Key) của một lược đồ quan hệ được hiểu chính xác nhất là gì?",
      options: [
        "Mọi siêu khóa bất kỳ tồn tại trong quan hệ",
        "Một khóa tối thiểu được người phân tích chọn",
        "Thuộc tính khóa ngoại trỏ sang quan hệ khác",
        "Tập hợp tất cả các thuộc tính của quan hệ đó"
      ],
      correctAnswer: 1,
      explanation: "Khóa chính (Primary Key) là một khóa tối thiểu (trong số các khóa dự tuyển) được người phân tích - thiết kế lựa chọn để cài đặt định danh."
    }
  ];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-[11px] font-bold uppercase tracking-wider text-orange-600">
              Kiểm Tra Nhanh Kiến Thức • Phần I (Chương II)
            </span>
            <h3 className="text-lg font-extrabold text-slate-900">
              Củng Cố: Các Định Nghĩa Của Mô Hình Dữ Liệu Quan Hệ
            </h3>
          </div>
        </div>
      ...
      {showResults && (
        <div className="mt-6 p-4 rounded-xl bg-orange-50 border border-orange-200 flex items-center justify-between shadow-sm">
          ...
          <span className="text-xs text-amber-800 font-semibold font-mono">
            {calculateScore() === questions.length ? "Xuất sắc! Nắm vững 100% Phần I Chương II" : "Hãy ôn lại các câu trả lời chưa đúng nhé!"}
          </span>
        </div>
      )}
    </div>
