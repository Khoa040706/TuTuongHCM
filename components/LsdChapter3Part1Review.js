...
export default function LsdChapter3Part1Review() {
  ...
  const flashcards = [
    {
      q: "Cuộc Tổng tuyển cử bầu Quốc hội chung khóa VI diễn ra vào ngày tháng năm nào?",
      a: "Ngày 25-4-1976 (với hơn 23 triệu cử tri, đạt 98,77% đi bầu)."
    },
    {
      q: "Đại hội IV của Đảng (12-1976) đã quyết định đổi tên Đảng như thế nào?",
      a: "Đổi tên từ 'Đảng Lao động Việt Nam' thành 'Đảng Cộng sản Việt Nam' và bầu đồng chí Lê Duẩn làm Tổng Bí thư."
    },
    {
      q: "Đại hội IV của Đảng xác định cuộc cách mạng nào giữ vai trò THEN CHỐT trong 3 cuộc cách mạng?",
      a: "Cách mạng Khoa học - Kỹ thuật giữ vai trò THEN CHỐT."
    },
    {
      q: "Tên nước chính thức được Quốc hội khóa VI (kỳ họp thứ nhất) quyết định vào năm 1976 là gì?",
  ...
  const keywords = [
    ...
    { title: "Cộng hòa XHCN Việt Nam", desc: "Tên nước chính thức được Quốc hội khóa VI thông qua năm 1976", cat: "Nhà nước" },
    { title: "Đại hội IV (12-1976)", desc: "Đổi tên Đảng thành Đảng Cộng sản Việt Nam, bầu Lê Duẩn làm Tổng Bí thư", cat: "Đại hội" },
    { title: "Cách mạng KH-KT", desc: "Giữ vai trò THEN CHỐT trong 3 cuộc cách mạng XHCN", cat: "Đường lối" },
    { title: "Chủ quan, nóng vội", desc: "Hạn chế chính của Đại hội IV khi đề ra chỉ tiêu kinh tế vượt khả năng thực tế", cat: "Hạn chế" }
  ];
    ...
    <div className="my-8 rounded-2xl border border-amber-300 dark:border-amber-700 bg-gradient-to-br from-amber-50/50 via-white to-red-50/40 p-6 md:p-8 shadow-xl">
      ...
      <div className="text-center max-w-3xl mx-auto mb-8">
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-600 text-white text-xs font-bold uppercase tracking-wider mb-2">
          <Star size={14} className="fill-amber-300 text-amber-300" /> Ôn tập Chương III - Mục I.1
        </span>
        <h3 className="text-2xl md:text-3xl font-black font-serif text-slate-900 dark:text-white">
          Hub Ôn Tập Trắc Nghiệm (1975 - 1981)
        </h3>
      </div>
