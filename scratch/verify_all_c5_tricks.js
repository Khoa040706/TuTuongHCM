...
const raw1 = fs.readFileSync('./data/questions-chuong-5-trick1.js', 'utf8');
const match1 = raw1.match(/export const trickSet1 = (\[[\s\S]*\]);/);
const trickSet1 = eval(match1[1]);

const raw2 = fs.readFileSync('./data/questions-chuong-5-trick2.js', 'utf8');
...
console.log(`Loaded TrickSet1 C5: ${trickSet1.length} questions.`);
console.log(`Loaded TrickSet2 C5: ${trickSet2.length} questions.`);
...
console.log(`Master Verification for Chapter V completed. Total Errors Found: ${totalErrors}`);
