import { lsdKetLuanTrick1 } from "../data/questions-lsd-ket-luan-trick1.js";
import { lsdKetLuanTrick2 } from "../data/questions-lsd-ket-luan-trick2.js";

console.log("=== QUY TRÌNH KIỂM THỬ TỰ ĐỘNG CÁC ĐỀ THI BẪY PHẦN KẾT LUẬN LỊCH SỬ ĐẢNG ===");

const allSets = [
  { name: "Đề Bẫy 1 (Trick Set 1)", questions: lsdKetLuanTrick1 },
  { name: "Đề Bẫy 2 (Trick Set 2)", questions: lsdKetLuanTrick2 }
];
...
if (failCount === 0) {
  console.log("🎉 TẤT CẢ 100 CÂU HỎI BẪY PHẦN KẾT LUẬN VƯỢT QUA 100% QUY TRÌNH KIỂM THỬ TỰ ĐỘNG!");
} else {
  process.exit(1);
}
