import { questionsLsdDh6Part1 } from "../data/questions-lsd-dh6-part1.js";
import { questionsLsdDh6Part2 } from "../data/questions-lsd-dh6-part2.js";
import { questionsLsdDh6Trick1 } from "../data/questions-lsd-dh6-trick1.js";
import { questionsLsdDh6Trick2 } from "../data/questions-lsd-dh6-trick2.js";

console.log("==================================================");
console.log("🚀 CHƯƠNG TRÌNH KIỂM THỬ TỰ ĐỘNG ĐẠI HỘI VI (12/1986)");
console.log("==================================================");
...
verifyExamSet("questions-lsd-dh6-part1.js (Đề chuẩn 1)", questionsLsdDh6Part1, false);
verifyExamSet("questions-lsd-dh6-part2.js (Đề chuẩn 2)", questionsLsdDh6Part2, false);
verifyExamSet("questions-lsd-dh6-trick1.js (Đề bẫy 1)", questionsLsdDh6Trick1, true);
verifyExamSet("questions-lsd-dh6-trick2.js (Đề bẫy 2)", questionsLsdDh6Trick2, true);

console.log("\n==================================================");
if (totalErrors === 0) {
  console.log("🎉 TẤT CẢ 180 CÂU HỎI ĐẠI HỘI VI VƯỢT QUA 100% QUY TRÌNH KIỂM THỬ TỰ ĐỘNG!");
  console.log("==================================================");
} else {
