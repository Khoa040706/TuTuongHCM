...
const trickSet1 = [
  // --- NHÓM 1: QUY LUẬT RA ĐỜI & VAI TRÒ LÃNH ĐẠO CỦA ĐẢNG (12 CÂU) ---
  {
    id: "hcm-c4-tr1-001",
    trickSet: 1,
  ...
  // --- NHÓM 2: BẢN CHẤT GIAI CẤP CỦA ĐẢNG (12 CÂU) ---
  {
    id: "hcm-c4-tr1-013",
    trickSet: 1,
    sectionId: "hcm-ve-dang-csvn-sec",
  ...
  // --- NHÓM 3: CÁC NGUYÊN TẮC TỔ CHỨC & SINH HOẠT ĐẢNG (14 CÂU) ---
  {
    id: "hcm-c4-tr1-025",
    trickSet: 1,
    sectionId: "hcm-ve-dang-csvn-sec",
  ...
  // --- NHÓM 4: XÂY DỰNG ĐẢNG CẦM QUYỀN VỀ ĐẠO ĐỨC & PHÒNG CHỐNG SUY THOÁI (14 CÂU) ---
  {
    id: "hcm-c4-tr1-037",
    trickSet: 1,
    sectionId: "hcm-ve-dang-csvn-sec",
...
console.log('Testing TrickSet1 (50 questions)...');
const checkRes = checkOptionLengths(trickSet1);
console.log('TrickSet1 max length diff:', checkRes.maxDiff);
console.log('TrickSet1 violations count:', checkRes.violations.length);

const overlaps = checkBlacklistOverlap(trickSet1);
console.log('TrickSet1 blacklist overlaps count:', overlaps.length);
...
`;
  fs.writeFileSync('./data/questions-chuong-4-trick1.js', fileContent, 'utf8');
  console.log('Successfully written data/questions-chuong-4-trick1.js!');
}
