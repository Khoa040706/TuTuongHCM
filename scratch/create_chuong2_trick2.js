...
// 50 diverse trick questions for Chapter II Trick Set 2
const questions = [
  // 1-15: Giai đoạn 1945-1946 (Củng cố chính quyền & Sách lược ngoại giao)
  {
    id: "lsd2-tr2-001",
    trickSet: 2,
  ...
  // 11-30: Giai đoạn 1946-1954 (Đường lối & Các chiến dịch lớn)
  {
    id: "lsd2-tr2-011",
    trickSet: 2,
    sectionId: "lsd2-sec-1",
  ...
  // 21-50: Giai đoạn 1954-1975 (Kháng chiến chống Mỹ cứu nước)
  {
    id: "lsd2-tr2-021",
    trickSet: 2,
...
export const lsdChuong2Trick2 = ${JSON.stringify(questions, null, 2)};
`;
  fs.writeFileSync("./data/questions-lsd-chuong-2-trick2.js", fileContent, "utf8");
  console.log("Successfully generated data/questions-lsd-chuong-2-trick2.js");
}
