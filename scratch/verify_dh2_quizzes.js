import { questionsLsdDh2Part1 } from "../data/questions-lsd-dh2-part1.js";
import { questionsLsdDh2Part2 } from "../data/questions-lsd-dh2-part2.js";
import { questionsLsdDh2Trick1 } from "../data/questions-lsd-dh2-trick1.js";
import { questionsLsdDh2Trick2 } from "../data/questions-lsd-dh2-trick2.js";

console.log("==================================================");
console.log("🚀 CHƯƠNG TRÌNH KIỂM THỬ TỰ ĐỘNG ĐẠI HỘI II (2/1951)");
console.log("==================================================");
...
verifyExamSet("questions-lsd-dh2-part1.js (Đề chuẩn 1)", questionsLsdDh2Part1, false);
verifyExamSet("questions-lsd-dh2-part2.js (Đề chuẩn 2)", questionsLsdDh2Part2, false);
verifyExamSet("questions-lsd-dh2-trick1.js (Đề bẫy 1)", questionsLsdDh2Trick1, true);
verifyExamSet("questions-lsd-dh2-trick2.js (Đề bẫy 2)", questionsLsdDh2Trick2, true);

console.log("\n==================================================");
if (totalErrors === 0) {
  console.log("🎉 TẤT CẢ 180 CÂU HỎI ĐẠI HỘI II VƯỢT QUA 100% QUY TRÌNH KIỂM THỬ TỰ ĐỘNG!");
  console.log("==================================================");
} else {
