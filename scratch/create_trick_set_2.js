...
const trickSet2 = [
  // --- NHÓM 1: BẢN CHẤT GIAI CẤP CỦA NHÀ NƯỚC VIỆT NAM (12 CÂU) ---
  {
    id: "hcm-c4-tr2-001",
    trickSet: 2,
  ...
  // --- NHÓM 2: NHÀ NƯỚC CỦA DÂN, DO DÂN, VÌ DÂN (14 CÂU) ---
  {
    id: "hcm-c4-tr2-013",
    trickSet: 2,
    sectionId: "hcm-ve-nha-nuoc-sec",
  ...
  // --- NHÓM 3: XÂY DỰNG NHÀ NƯỚC PHÁP QUYỀN CÓ HIỆU LỰC MẠNH MẼ (12 CÂU) ---
  {
    id: "hcm-c4-tr2-025",
    trickSet: 2,
    sectionId: "hcm-ve-nha-nuoc-sec",
  ...
  // --- NHÓM 4: XÂY DỰNG NHÀ NƯỚC TRONG SẠCH, PHÒNG CHỐNG TIÊU CỰC (14 CÂU) ---
  {
    id: "hcm-c4-tr2-037",
    trickSet: 2,
    sectionId: "hcm-ve-nha-nuoc-sec",
...
console.log('Testing TrickSet2 (50 questions)...');
const checkRes = checkOptionLengths(trickSet2);
console.log('TrickSet2 max length diff:', checkRes.maxDiff);
console.log('TrickSet2 violations count:', checkRes.violations.length);

const overlaps = checkBlacklistOverlap(trickSet2);
console.log('TrickSet2 blacklist overlaps count:', overlaps.length);
...
`;
  fs.writeFileSync('./data/questions-chuong-4-trick2.js', fileContent, 'utf8');
  console.log('Successfully written data/questions-chuong-4-trick2.js!');
}
