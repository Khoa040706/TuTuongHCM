import { questionsLsdDh5Part1 } from "../data/questions-lsd-dh5-part1.js";
import { questionsLsdDh5Part2 } from "../data/questions-lsd-dh5-part2.js";
import { questionsLsdDh5Trick1 } from "../data/questions-lsd-dh5-trick1.js";
import { questionsLsdDh5Trick2 } from "../data/questions-lsd-dh5-trick2.js";

console.log("==================================================");
console.log("🚀 CHƯƠNG TRÌNH KIỂM THỬ TỰ ĐỘNG ĐẠI HỘI V (3/1982)");
console.log("==================================================");
...
verifyExamSet("questions-lsd-dh5-part1.js (Đề chuẩn 1)", questionsLsdDh5Part1, false);
verifyExamSet("questions-lsd-dh5-part2.js (Đề chuẩn 2)", questionsLsdDh5Part2, false);
verifyExamSet("questions-lsd-dh5-trick1.js (Đề bẫy 1)", questionsLsdDh5Trick1, true);
verifyExamSet("questions-lsd-dh5-trick2.js (Đề bẫy 2)", questionsLsdDh5Trick2, true);

console.log("\n==================================================");
if (totalErrors === 0) {
  console.log("🎉 TẤT CẢ 180 CÂU HỎI ĐẠI HỘI V VƯỢT QUA 100% QUY TRÌNH KIỂM THỬ TỰ ĐỘNG!");
  console.log("==================================================");
} else {
