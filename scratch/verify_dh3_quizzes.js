import { questionsLsdDh3Part1 } from "../data/questions-lsd-dh3-part1.js";
import { questionsLsdDh3Part2 } from "../data/questions-lsd-dh3-part2.js";
import { questionsLsdDh3Trick1 } from "../data/questions-lsd-dh3-trick1.js";
import { questionsLsdDh3Trick2 } from "../data/questions-lsd-dh3-trick2.js";

console.log("==================================================");
console.log("🚀 CHƯƠNG TRÌNH KIỂM THỬ TỰ ĐỘNG ĐẠI HỘI III (9/1960)");
console.log("==================================================");
...
verifyExamSet("questions-lsd-dh3-part1.js (Đề chuẩn 1)", questionsLsdDh3Part1, false);
verifyExamSet("questions-lsd-dh3-part2.js (Đề chuẩn 2)", questionsLsdDh3Part2, false);
verifyExamSet("questions-lsd-dh3-trick1.js (Đề bẫy 1)", questionsLsdDh3Trick1, true);
verifyExamSet("questions-lsd-dh3-trick2.js (Đề bẫy 2)", questionsLsdDh3Trick2, true);

console.log("\n==================================================");
if (totalErrors === 0) {
  console.log("🎉 TẤT CẢ 180 CÂU HỎI ĐẠI HỘI III VƯỢT QUA 100% QUY TRÌNH KIỂM THỬ TỰ ĐỘNG!");
  console.log("==================================================");
} else {
