import { lsdChuong3Trick1 } from "../data/questions-lsd-chuong-3-trick1.js";
import { lsdChuong3Trick2 } from "../data/questions-lsd-chuong-3-trick2.js";

console.log("=== QUY TRÌNH KIỂM THỬ TỰ ĐỘNG CÁC ĐỀ THI BẪY CHƯƠNG III LỊCH SỬ ĐẢNG ===");

const allSets = [
  { name: "Đề Bẫy 1 (Trick Set 1)", questions: lsdChuong3Trick1 },
  { name: "Đề Bẫy 2 (Trick Set 2)", questions: lsdChuong3Trick2 }
];
...
if (failCount === 0) {
  console.log("🎉 TẤT CẢ 100 CÂU HỎI BẪY CHƯƠNG III VƯỢT QUA 100% QUY TRÌNH KIỂM THỬ TỰ ĐỘNG!");
} else {
  process.exit(1);
}
