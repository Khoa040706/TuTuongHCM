...
const raw1 = fs.readFileSync('./data/questions-chuong-4-trick1.js', 'utf8');
const match1 = raw1.match(/export const trickSet1 = (\[[\s\S]*\]);/);
const trickSet1 = eval(match1[1]);

const raw2 = fs.readFileSync('./data/questions-chuong-4-trick2.js', 'utf8');
...
console.log(`Loaded TrickSet1: ${trickSet1.length} questions.`);
console.log(`Loaded TrickSet2: ${trickSet2.length} questions.`);
...
console.log(`Master Verification completed. Total Errors Found: ${totalErrors}`);
