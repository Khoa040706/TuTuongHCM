import { questionsLsdDh4Part1 } from "../data/questions-lsd-dh4-part1.js";
import { questionsLsdDh4Part2 } from "../data/questions-lsd-dh4-part2.js";
import { questionsLsdDh4Trick1 } from "../data/questions-lsd-dh4-trick1.js";
import { questionsLsdDh4Trick2 } from "../data/questions-lsd-dh4-trick2.js";

console.log("==================================================");
console.log("🚀 CHƯƠNG TRÌNH KIỂM THỬ TỰ ĐỘNG ĐẠI HỘI IV (12/1976)");
console.log("==================================================");
...
verifyExamSet("questions-lsd-dh4-part1.js (Đề chuẩn 1)", questionsLsdDh4Part1, false);
verifyExamSet("questions-lsd-dh4-part2.js (Đề chuẩn 2)", questionsLsdDh4Part2, false);
verifyExamSet("questions-lsd-dh4-trick1.js (Đề bẫy 1)", questionsLsdDh4Trick1, true);
verifyExamSet("questions-lsd-dh4-trick2.js (Đề bẫy 2)", questionsLsdDh4Trick2, true);

console.log("\n==================================================");
if (totalErrors === 0) {
  console.log("🎉 TẤT CẢ 180 CÂU HỎI ĐẠI HỘI IV VƯỢT QUA 100% QUY TRÌNH KIỂM THỬ TỰ ĐỘNG!");
  console.log("==================================================");
} else {
